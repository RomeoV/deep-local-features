...
class DistinctivenessLoss(nn.Module):
    def __init__(self, margin=0.5, safe_radius=4, scaling_steps=3, N=32):
        super().__init__()
        self.margin = margin
        self.safe_radius = safe_radius
        self.scaling_steps = scaling_steps
...
class Distinctiveness2Loss(nn.Module):
    def __init__(self, margin=1, safe_radius=4, scaling_steps=3, N=2):
        super().__init__()
        self.margin = margin
        self.safe_radius = safe_radius
        self.scaling_steps = scaling_steps
