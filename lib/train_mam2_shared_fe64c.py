...
class MultiAttentionLayer2Shared(LightningModule):
...
if __name__=="__main__":
    ...
    if REP_LOSS:
        ...
        tb_logger = TensorBoardLogger('tb_logs', name='cfe64_multi_attention_model2_distinctiveness+_lossN32_lambda03_sm_lowmargin')
