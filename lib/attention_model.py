...
if __name__ == "__main__":
    autoencoder = CorrespondenceEncoder.load_from_checkpoint(
        "tb_logs/correspondence_encoder_lr1e3/version_0/checkpoints/epoch=7-step=1159_interm.ckpt").requires_grad_(False)
    ...
    if REP_LOSS:
        ...
        tb_logger = TensorBoardLogger(
            'tb_logs', name='cfe_attention_model_delf_normsum_distinctiveness+_loss')
