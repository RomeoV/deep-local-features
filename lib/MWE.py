...
if __name__ == "__main__":
    base_path = "/mnt/c/Users/phill/polybox/Deep Learning/MegaDepthDataset/"
    dataset = MegaDepthDataset(scene_list_path=f"{base_path}/valid_scenes.txt", scene_info_path=f"{base_path}/scene_info", base_path=base_path)
